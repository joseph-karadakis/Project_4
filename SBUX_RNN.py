...
sbux_df['Open'].plot(figsize=(16, 6))
sbux_df.rolling(100).mean()['Open'].plot()

# %%
training_df = sbux_df['Open']
...
sbux_data_copy = sbux_data.copy()
df_test = sbux_data_copy.tail(40)

# Remove the test data from sbux_data for further partitioning
sbux_data_copy = sbux_data_copy[:-40]

# Calculate the training data size (80% of the remaining data)
train_size = int(0.8 * len(sbux_data_copy))

# Split the data into training and validation sets
train_data = sbux_data_copy[:train_size]
val_data = sbux_data_copy[train_size:]
