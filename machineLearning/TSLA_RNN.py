...
TSLA_df.rolling(100).mean()['Open'].plot()

# %%
training_df = TSLA_df['Open']
...
# %%
df_total = pd.concat((TSLA_df['Open'], df_test['Open']), axis = 0)
...
TSLA_data_copy = TSLA_data.copy()
df_test = TSLA_data_copy.tail(40)


# %%

# Remove the test data from TSLA_data for further partitioning
TSLA_data_copy = TSLA_data_copy[:-40]


# %%

# Calculate the training data size (80% of the remaining data)
train_size = int(0.8 * len(TSLA_data_copy))


# %%

# Split the data into training and validation sets
train_data = TSLA_data_copy[:train_size]
val_data = TSLA_data_copy[train_size:]
